...
public class FinalSubmissionAssignmentHoldAdapter extends RecyclerView.Adapter<FinalSubmissionAssignmentHoldAdapter.MyViewHolder> {
    FinalSubmissionAssignmentHoldActivity finalSubmissionAssignmentHoldactivity;
    ...
    public FinalSubmissionAssignmentHoldAdapter(FinalSubmissionAssignmentHoldActivity finalSubmissionAssignmentHoldactivity, List<MyAssignment.MyAssignmentData> data, Context context, String visusService, String visusServiceID) {
        this.finalSubmissionAssignmentHoldactivity = finalSubmissionAssignmentHoldactivity;
        this.data = data;
                ...
                holder.view_action.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (ConnectionUtility.isConnected(context)) {
                            ...
                            Toast.makeText(finalSubmissionAssignmentHoldactivity, "SORRY!! No Internet Available", Toast.LENGTH_LONG).show();
                        }
